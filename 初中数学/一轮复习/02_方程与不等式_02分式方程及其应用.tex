...
\end{solution}
    ...
    \item 甲、乙两地相距\(1000 \kilo\metre \),如果乘高铁列车从甲地到乙地比乘特快列车少用\(3 h.\)已知高铁列车的平均速度是特快列车的\(1.6\)倍,设特快列车的平均速度为\(x \kilo\metre\per\hour \),根据题意可列方程为\tkt{\(\frac{1000}{x}-\frac{1000}{1.6x}=3\)}  .
